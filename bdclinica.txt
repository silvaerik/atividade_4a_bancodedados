...
-- inclusao e selecao dos dados -------------------------------------

-- tabela paciente --
insert into paciente values('012.345.678-90','Leonardo Ribeiro','(11)01234-5676',123456,'Inovamed','Padrao');
insert into paciente values('123.456.789-12','Bruna Alvez','(15)92345-6789',234567,'Ultramed','Basico');
insert into paciente values('234.567.890-23','Gilberto Barros','(11)94567-8901',345678,'Inovamed','Especial');
insert into paciente values('345.678.901-45','Maria Pereira','(11)95678-9012',456789,'Ultramed','Padrao');
insert into paciente values('456.789.012-34','Arnaldo Coelho','(11)96789-0123',567890,'Inovamed','Especial');
...
insert into medico values(203040,'Marcia Alvez','Gastrologia');
insert into medico values(304050,'Roberto Gusmao','Neurologia');
